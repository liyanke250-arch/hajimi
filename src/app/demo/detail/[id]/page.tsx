/**
 * 题目详情页面 - 优化版
 * 文件路径: src/app/demo/detail/[id]/page.tsx
 * 创建时间: 2025-10-05
 */
      ...
      <nav className="bg-white/80 backdrop-blur-md border-b sticky top-0 z-50 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <span className="text-sm font-mono text-gray-500">{question.sourceId}</span>
                  ...
                  <div key={opt.id} className={`p-4 rounded-xl border-2 transition-all ${
                    ...
                    {opt.analysisText && (
                      <div className="mt-3 pt-3 border-t border-gray-200">
                        <p className="text-sm text-gray-700">{opt.analysisText}</p>
                      </div>
                    )}
                  </div>
                ))}
